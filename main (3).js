...
const mapControls = {
  ...
  startMovie: function () {
    console.log("🍿 Starting Movie Sequence...");
    
    // 1. Sembunyikan Menu GUI
    gui.domElement.style.display = "none";
    
    // 2. Load Map Pertama
    // (Karena di dalam scene_City sudah ada logika transisi ke scene 2, 
    // dia akan otomatis berlanjut sampai scene 5 dan looping).
    loadMap("1. City");
    
    // Opsional: Pastikan mobil reset
    if(carSettings) carSettings.autoDrive = true;
  }
};
...
mapFolder.add(mapControls, "startMovie").name("▶ START MOVIE (1-5)");
mapFolder.open();
